...
import id.sch.smktelkom_mlg.privateassignment.xirpl325.pilmindo.adapter.PopulerMovie_Adapter;
...
public class PopulerFragment extends Fragment {
    ArrayList<Results> m_List2 = new ArrayList<>();
    PopulerMovie_Adapter populermovie;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.recyclerView_populer);
        rv.setHasFixedSize(true);
        populermovie = new PopulerMovie_Adapter(this,m_List2, getContext());
        rv.setAdapter(populermovie);
    ...
    private void downloadDataSources() {
        String url = "https://api.themoviedb.org/3/movie/popular?api_key=70f354f1f8ae96f11d8c36c05208ba86&language=en-US&page=1";
        ...
        GsonGetRequest<ResultsResponse> myRequest = new GsonGetRequest<ResultsResponse>
                (url, ResultsResponse.class, null, new Response.Listener<ResultsResponse>() {
                    ...
                    public void onResponse(ResultsResponse response) {
                        ...
                        m_List2.addAll(response.results);
                        populermovie.notifyDataSetChanged();
                    }
